...
class Ui_menu_view(object):
    def setupUi(self, menu_view):
        ...
        self.btn_4bytes_s0.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.btn_4bytes_s1.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.btn_4bytes_s2.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.btn_4bytes_s3.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.btn_8bytes_s0.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.btn_8bytes_s1.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.verticalLayout.addWidget(self.btn_start_countdown)

        self.placeholder_countdown_display = QWidget(self.Main)
        self.placeholder_countdown_display.setObjectName(u"placeholder_countdown_display")
        sizePolicy3.setHeightForWidth(self.placeholder_countdown_display.sizePolicy().hasHeightForWidth())
        self.placeholder_countdown_display.setSizePolicy(sizePolicy3)
        self.placeholder_countdown_display.setMinimumSize(QSize(0, 0))

        self.verticalLayout.addWidget(self.placeholder_countdown_display)
        ...
        sizePolicy4.setHeightForWidth(self.lbl_timeline_title.sizePolicy().hasHeightForWidth())
        self.lbl_timeline_title.setSizePolicy(sizePolicy4)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 148, 317))
        ...
        sizePolicy6.setHeightForWidth(self.btn_stop_timeline.sizePolicy().hasHeightForWidth())
        self.btn_stop_timeline.setSizePolicy(sizePolicy6)
        ...
        sizePolicy3.setHeightForWidth(self.placeholder_eye_manager.sizePolicy().hasHeightForWidth())
        self.placeholder_eye_manager.setSizePolicy(sizePolicy3)
        ...
        sizePolicy7.setHeightForWidth(self.btn_create_resource.sizePolicy().hasHeightForWidth())
        self.btn_create_resource.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.btn_delete_resource.sizePolicy().hasHeightForWidth())
        self.btn_delete_resource.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.textEdit.sizePolicy().hasHeightForWidth())
        self.textEdit.setSizePolicy(sizePolicy8)
        ...
        sizePolicy7.setHeightForWidth(self.gv_img_preview.sizePolicy().hasHeightForWidth())
        self.gv_img_preview.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.btn_create_config.sizePolicy().hasHeightForWidth())
        self.btn_create_config.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.btn_save_config.sizePolicy().hasHeightForWidth())
        self.btn_save_config.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.btn_load_config.sizePolicy().hasHeightForWidth())
        self.btn_load_config.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.btn_eye_manager.sizePolicy().hasHeightForWidth())
        self.btn_eye_manager.setSizePolicy(sizePolicy8)
        self.btn_eye_manager.setMinimumSize(QSize(0, 0))
        ...
        sizePolicy8.setHeightForWidth(self.btn_configs.sizePolicy().hasHeightForWidth())
        self.btn_configs.setSizePolicy(sizePolicy8)
        self.btn_configs.setMinimumSize(QSize(0, 0))
        ...
        sizePolicy8.setHeightForWidth(self.btn_preferences.sizePolicy().hasHeightForWidth())
        self.btn_preferences.setSizePolicy(sizePolicy8)
        self.btn_preferences.setMinimumSize(QSize(0, 0))
        ...
        sizePolicy8.setHeightForWidth(self.btn_debug.sizePolicy().hasHeightForWidth())
        self.btn_debug.setSizePolicy(sizePolicy8)
