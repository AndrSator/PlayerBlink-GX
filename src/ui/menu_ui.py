...
class Ui_menu_view(object):
    def setupUi(self, menu_view):
        ...
        self.gbox_adv_timeline.setMaximumSize(QSize(175, 16777215))
        ...
        self.gbox_adv_timeline_scroll = QGroupBox(self.gbox_adv_timeline)
        self.gbox_adv_timeline_scroll.setObjectName(u"gbox_adv_timeline_scroll")
        self.verticalLayout_11 = QVBoxLayout(self.gbox_adv_timeline_scroll)
        self.verticalLayout_11.setSpacing(5)
        self.verticalLayout_11.setObjectName(u"verticalLayout_11")
        self.verticalLayout_11.setContentsMargins(10, 10, 10, 10)
        self.scrollArea = QScrollArea(self.gbox_adv_timeline_scroll)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 131, 444))
        ...
        self.verticalLayout_20.addLayout(self.list_advance_timeline)
        ...
        self.verticalLayout.addWidget(self.gbox_adv_timeline_scroll)
        ...
        self.chkb_auto_start_countdown.setChecked(False)
        ...
        self.btn_8bytes_s0.setFlat(True)
        ...
        self.btn_4bytes_s0.setFlat(True)
        ...
        self.btn_4bytes_s1.setFlat(True)
        ...
        self.btn_8bytes_s1.setFlat(True)
        ...
        self.btn_4bytes_s2.setFlat(True)
        ...
        self.btn_4bytes_s3.setFlat(True)
        ...
        self.lbl_npcs_during_timeline = QLabel(self.gbox_calibration)
        self.lbl_npcs_during_timeline.setObjectName(u"lbl_npcs_during_timeline")

        self.horizontalLayout_21.addWidget(self.lbl_npcs_during_timeline)

        self.spin_npcs_timeline = QSpinBox(self.gbox_calibration)
        self.spin_npcs_timeline.setObjectName(u"spin_npcs_timeline")
        self.spin_npcs_timeline.setMinimumSize(QSize(0, 25))
        self.spin_npcs_timeline.setFrame(False)
        self.spin_npcs_timeline.setAlignment(Qt.AlignCenter)
        self.spin_npcs_timeline.setReadOnly(False)
        self.spin_npcs_timeline.setButtonSymbols(QAbstractSpinBox.UpDownArrows)
        self.spin_npcs_timeline.setSpecialValueText(u"")
        self.spin_npcs_timeline.setKeyboardTracking(False)
        self.spin_npcs_timeline.setMinimum(-1)
        self.spin_npcs_timeline.setMaximum(50)
        self.spin_npcs_timeline.setValue(0)

        self.horizontalLayout_21.addWidget(self.spin_npcs_timeline)
        ...
        self.lbl_pkmn_npcs_timeline = QLabel(self.gbox_calibration)
        self.lbl_pkmn_npcs_timeline.setObjectName(u"lbl_pkmn_npcs_timeline")

        self.horizontalLayout_22.addWidget(self.lbl_pkmn_npcs_timeline)

        self.spin_pkmn_npcs_timeline = QSpinBox(self.gbox_calibration)
        self.spin_pkmn_npcs_timeline.setObjectName(u"spin_pkmn_npcs_timeline")
        self.spin_pkmn_npcs_timeline.setMinimumSize(QSize(0, 25))
        self.spin_pkmn_npcs_timeline.setFrame(False)
        self.spin_pkmn_npcs_timeline.setAlignment(Qt.AlignCenter)
        self.spin_pkmn_npcs_timeline.setReadOnly(False)
        self.spin_pkmn_npcs_timeline.setButtonSymbols(QAbstractSpinBox.UpDownArrows)
        self.spin_pkmn_npcs_timeline.setSpecialValueText(u"")
        self.spin_pkmn_npcs_timeline.setKeyboardTracking(False)
        self.spin_pkmn_npcs_timeline.setMinimum(0)
        self.spin_pkmn_npcs_timeline.setMaximum(50)
        self.spin_pkmn_npcs_timeline.setValue(0)

        self.horizontalLayout_22.addWidget(self.spin_pkmn_npcs_timeline)
        ...
        self.chkb_reident_pkmn_npc.setChecked(False)
        ...
        self.lbl_cfg_npcs_timeline = QLabel(self.gbox_config_preview)
        self.lbl_cfg_npcs_timeline.setObjectName(u"lbl_cfg_npcs_timeline")

        self.horizontalLayout_58.addWidget(self.lbl_cfg_npcs_timeline)
        ...
        self.lbl_cfg_npcs_timeline_value = QLabel(self.gbox_config_preview)
        self.lbl_cfg_npcs_timeline_value.setObjectName(u"lbl_cfg_npcs_timeline_value")
        self.lbl_cfg_npcs_timeline_value.setMinimumSize(QSize(0, 25))

        self.horizontalLayout_58.addWidget(self.lbl_cfg_npcs_timeline_value)
        ...
        self.lbl_cfg_pkmn_npcs_timeline = QLabel(self.gbox_config_preview)
        self.lbl_cfg_pkmn_npcs_timeline.setObjectName(u"lbl_cfg_pkmn_npcs_timeline")

        self.horizontalLayout_59.addWidget(self.lbl_cfg_pkmn_npcs_timeline)
        ...
        self.lbl_cfg_pkmn_npcs_timeline_value = QLabel(self.gbox_config_preview)
        self.lbl_cfg_pkmn_npcs_timeline_value.setObjectName(u"lbl_cfg_pkmn_npcs_timeline_value")
        self.lbl_cfg_pkmn_npcs_timeline_value.setMinimumSize(QSize(0, 25))

        self.horizontalLayout_59.addWidget(self.lbl_cfg_pkmn_npcs_timeline_value)
    ...
    def retranslateUi(self, menu_view):
        ...
        self.gbox_adv_timeline_scroll.setTitle("")
        self.gbox_adv_timeline_scroll.setProperty(u"class", QCoreApplication.translate("menu_view", u"lower", None))
        ...
        self.lbl_npcs_during_timeline.setText(QCoreApplication.translate("menu_view", u"NPCs dur. timeline", None))
        self.spin_npcs_timeline.setSuffix("")
        self.spin_npcs_timeline.setPrefix("")
        self.lbl_pkmn_npcs_timeline.setText(QCoreApplication.translate("menu_view", u"PKMNs NPCs dur. timeline", None))
        self.spin_pkmn_npcs_timeline.setSuffix("")
        self.spin_pkmn_npcs_timeline.setPrefix("")
        ...
        self.lbl_cfg_npcs_timeline.setText(QCoreApplication.translate("menu_view", u"NPCs during timeline", None))
        self.lbl_cfg_npcs_timeline_value.setText(QCoreApplication.translate("menu_view", u"0", None))
        self.lbl_cfg_pkmn_npcs_timeline.setText(QCoreApplication.translate("menu_view", u"Pok\u00e9mon NPCs during timeline", None))
        self.lbl_cfg_pkmn_npcs_timeline_value.setText(QCoreApplication.translate("menu_view", u"0", None))
