...
class Ui_tv_view(object):
    def setupUi(self, tv_view):
        ...
        self.btn_device_prev.setMinimumSize(QSize(0, 32))
        ...
        self.btn_device_refresh.setMinimumSize(QSize(0, 32))
        ...
        self.btn_device_next.setMinimumSize(QSize(0, 32))
        ...
        self.cmb_windows_list.setMinimumSize(QSize(0, 32))
        ...
        self.switch_capture.setMinimumSize(QSize(32, 32))
        self.switch_capture.setMaximumSize(QSize(32, 32))
        ...
        self.switch_pause.setMinimumSize(QSize(32, 32))
        self.switch_pause.setMaximumSize(QSize(32, 32))
        ...
        self.btn_adjust_screen.setMinimumSize(QSize(32, 32))
        self.btn_adjust_screen.setMaximumSize(QSize(32, 32))
        ...
        self.switch_crop_tracking_area.setMinimumSize(QSize(32, 32))
        self.switch_crop_tracking_area.setMaximumSize(QSize(32, 32))
        ...
        self.switch_crop_eye.setMinimumSize(QSize(32, 32))
        self.switch_crop_eye.setMaximumSize(QSize(32, 32))
        ...
        self.switch_monitor_mode.setMinimumSize(QSize(32, 32))
        self.switch_monitor_mode.setMaximumSize(QSize(32, 32))
